...
export default function Login(props) {
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
         <Image source={require('../../../../assets/hucha.png')} resizeMode='contain' style={styles.logotype}/>
          ...
          <Button title="¡Registrate!" icon={{ name: '', type: 'material-community', size: 15, color:'blue'}} buttonStyle={styles.btn} containerStyle={styles.btnCont} onPress={() => navigation.navigate('createUserStack')}></Button>
